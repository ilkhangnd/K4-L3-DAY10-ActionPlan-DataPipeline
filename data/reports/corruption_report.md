...
| Mean token F1 | 0.8370 | 0.6370 | 0.8370 |
| Judge accuracy | 80.00% | 60.00% | 80.00% |
| Mean judge score | 4.4000 | 3.8000 | 4.4000 |
...
| --- | --- | --- |
| Baseline | llm | Set RUN_RAGAS=1 to enable the slower Ragas pass. |
| Corrupted | llm | Set RUN_RAGAS=1 to enable the slower Ragas pass. |
| Repaired | llm | Set RUN_RAGAS=1 to enable the slower Ragas pass. |
